class Aggregator
  ...
  def self.generate_news
    ...
    news << { name: "hardcoded", link: "http://www.google.com/", description: "", articles: [] }
    news[1][:articles] << { title: 'hardcoded article', description: 'hardcoded description', link: 'http://www.google.com' }
    news
  end
end
